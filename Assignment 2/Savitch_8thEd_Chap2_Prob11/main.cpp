 ...
 * File:   main.cpp
 * Author: Kai Ming Yau
 * Created on January 15, 2014, 9:39 PM
 * Problem 11
 */
...
int main(int argc, char** argv) {
    ...
    if(t10<=0)
        sumnn+=t10;
    //calculate the average sum of all positive , negative and all numbers
    avaan= static_cast<float>(suman)/10;
    avapn= static_cast<float>(sumpn)/10;
    avann= static_cast<float>(sumnn)/10;
    //Output the result
    cout<<"The sum of all the numbers = "<<suman<<endl;
    cout<<"The average of all numbers = "<<avaan<<endl;
    cout<<"The sum of positive numbers = "<<sumpn<<endl;
    cout<<"The average of all positive numbers = "<<avapn<<endl;
    cout<<"The sum of negative or zero numbers = "<<sumnn<<endl;
    cout<<"The average of all negative numbers = "<<avann<<endl;
    //Exit Stage Right
    return 0;
}
